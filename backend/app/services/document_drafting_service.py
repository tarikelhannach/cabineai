...
class DocumentDraftingService:
    ...
    def generate_from_template(
        ...
        system_prompt = """أنت مساعد قانوني متخصص في صياغة الوثائق القانونية المغربية.
مهمتك هي تحسين وصقل الوثيقة القانونية المقدمة، مع التأكد من:
1. الامتثال للمعايير القانونية المغربية
2. الصياغة القانونية الدقيقة والاحترافية
3. الوضوح والدقة في التعبير
4. استخدام المصطلحات القانونية المناسبة
...
قم بتحسين هذه الوثيقة مع الحفاظ على جميع المعلومات المهمة."""
    ...
    def generate_from_prompt(
        ...
        system_prompt = f"""أنت محامٍ مغربي خبير متخصص في صياغة الوثائق القانونية.
مهمتك هي إنشاء {doc_type_ar} وفقاً للمعايير القانونية المغربية.

يجب أن تتضمن الوثيقة:
1. صياغة قانونية دقيقة ومهنية
2. المصطلحات القانونية المناسبة
3. الهيكل القانوني الصحيح للوثيقة
4. الامتثال للتشريعات المغربية
5. الوضوح والدقة في التعبير

قم بإنشاء الوثيقة كاملة وجاهزة للاستخدام."""
